/**
 * RoverApp.java -- CS416 P2 -- Spring 2009
 * 
...
public class RoverApp extends JFrame
{
   //-------------------- class variables -------------------------
   //---- These are actually "application" parameters, specified
   //---- on the command line and available to any class
   //
   public static int  highSpeed    = 20;
   public static int  normalSpeed  = 5;
   public static int  nLocations = 3; 
   
   //------------------ constructor ---------------------------------
   /**
    * Construct a JFrame for the application and put a JPanel in it.
    */
   public RoverApp( String title, String[] args )
   {
      ...
      highSpeed    = getArg( args, 0, 20 ); // arg 0 is high speed
      normalSpeed  = getArg( args, 1, 5 ); // arg 1 is normal speed
      nLocations = getArg( args, 2, 3 );  // arg 2 is number of hospitals
              
      RoverPanel panel = new RoverPanel( this ); // Put graphics in JPanel
   ...
   {
      RoverApp app = new RoverApp( "Drawing in AWT/Swing", args );
   }
}